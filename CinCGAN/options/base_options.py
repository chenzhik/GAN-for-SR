...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--loadSize', type=int, default=158, help='scale images to this size')
        ...
        parser.add_argument('--display_winsize', type=int, default=128*4, help='display window size')
